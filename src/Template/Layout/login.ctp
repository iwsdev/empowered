...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo $this->Url->build(array('controller' => 'pages', 'action' => 'display', 'dashboard')); ?>">
          <?php //echo Configure::read('Theme.logo.large'); ?>
           <img src="<?php echo $this->request->webroot?>img/logo/logo.png" style="margin-top:-13px;height:70px !important;width:200px !important;">
          <?php //echo "<h3 style='color:rgb(0,23,71);font-weight: bold;'>".'Empowered Achiever</br> Admin Panel'."</h3>"; ?>
    </a> 
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    if (Configure::read('Theme.login.show_remember')) {
        ?>
        <a href="<?php echo $this->Url->build('/users/forgetpass');?>"><?php echo __('Forgot password') ?></a><br>
        <?php
    }
